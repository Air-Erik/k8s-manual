...
**Этап 0.1.1 — Исследование (IN PROGRESS):**
  ...
  - [ ] **← СЛЕДУЮЩИЙ ШАГ:** Оператор изучает образовательные материалы
  - [ ] Оператор исследует NSX-T (сегмент VIP-VM, DFW, SpoofGuard, MTU)
  - [ ] Оператор заполняет: `research/nsx-analysis/05-investigation-results.md`

**Этап 0.1.2 — Анализ и решение:**
  - [ ] AI-агент анализирует собранные данные
  - [ ] AI-агент создаёт рекомендацию: `research/nsx-analysis/06-decision-analysis.md`
  - [ ] Оператор принимает решение: использовать VIP-VM или создать новый сегмент

**Этап 0.1.3 — Настройка:**
  - [ ] AI-агент создаёт пошаговые инструкции (07 или 08, в зависимости от решения)
...
- 🟡 Этап 0: Подготовка инфраструктуры — **IN PROGRESS** (25% — образовательные материалы готовы, ожидается исследование)
...
2. ✅ **AI-агент** создал все вспомогательные файлы и шаблоны (README, валидация, финальные конфиги)
3. **Оператор** изучает материалы (research/nsx-analysis/01-03) ⬅️ **ВЫ ЗДЕСЬ**
4. **Оператор** исследует текущую NSX-T и заполняет 05-investigation-results.md
5. **AI-агент** анализирует данные и даёт рекомендации (06-decision-analysis.md)
6. **AI-агент** создаёт пошаговые инструкции (07 или 08)
7. **Оператор** применяет инструкции в NSX-T
8. **Оператор** проходит валидацию (09-validation-checklist.md)
9. Переход к задаче 0.2 (VM Preparation)
